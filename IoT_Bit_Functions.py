...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        """DisplaySMS Entry Box"""
        self.f = Entry(self)
        self.f.grid(row = 2, column = 1, sticky = W)

        """Delete SMS entry Box"""
        self.g = Entry(self)
        ...
        """GPIO Low/High Pin setup Button"""
    ...
    def Use_Camera(self):
        ...
        """Looks for the last SMS Recived and Read"""
        ...
        """Takes action based on the last recived SMS to either Take a Picture or Start a Recording"""
    ...
    def Signal_check(self):
        ...
        """Gets reed of the ',' to bea able to take an integer and compere"""
    ...
    def Set_Pins(self):
        ...
        '''Set pins to high or low depending on the last SMS'''
        ...
        """Turns GPIO to either High or Low depending on the last SMS"""
