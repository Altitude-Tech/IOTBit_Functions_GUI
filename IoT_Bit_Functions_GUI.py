...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        self.submit_button = Button(self, text = " PopUp  ", command = self.Popup)
        self.submit_button.grid(row = 3, column = 2, sticky = W)
        ...
        self.submit_button = Button(self, text = "          Start PWM         ", command = self.PWM)
        self.submit_button.grid(row = 2, column = 3, sticky = W)

        self.submit_button = Button(self, text = "          Show Map         ", command = self.Show_Map)
